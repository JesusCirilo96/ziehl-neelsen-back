...
CREATE TABLE IF NOT EXISTS `laboratorio`.`examen_general` (
  ...
  `TITULO_EXAMEN_IZQUIERDO` VARCHAR(45) NULL,
  `TITULO_EXAMEN_CENTRO` VARCHAR(45) NULL,
  `TITULO_EXAMEN_DERECHO` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `laboratorio`.`cat_seccion` (
  ...
  `TEXTO_CENTRO` VARCHAR(100) NULL,
  `TEXTO_DERECHO` VARCHAR(50) NULL,
  `ESTADO` TINYINT NOT NULL DEFAULT 1,
  `FECHA_CREACION` DATETIME NOT NULL,
  `FECHA_ACTUALIZACION` DATETIME NOT NULL,
