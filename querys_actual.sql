...
INSERT INTO 
    examen_general (examen_id, nombre, alias, titulo_examen,estado, precio, clave,layout, categoria_id, fecha_creacion, fecha_actualizacion) 
VALUES
(1, 'Citometria Hematica Completa','','',1,100.0,'','5',1,now(),now()),
(2, 'Velocidad de Sedimentacion Eritrocitaria(VSG)','','',1,100.0,'','1',1,now(),now()),
